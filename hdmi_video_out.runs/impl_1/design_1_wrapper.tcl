...
namespace eval ::optrace {
  variable script "C:/Git/hdmi_video_out/hdmi_video_out.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet C:/Git/hdmi_video_out/hdmi_video_out.runs/synth_1/design_1_wrapper.dcp
