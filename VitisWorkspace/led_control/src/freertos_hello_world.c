...
//#include "bare-arm/main.h"
#include "minimal/main.h"


#include "priority_queue/priority_queue_example.h"
...
static TaskHandle_t xLedControl;
...
//	xTimerStart( xTimer, 0 );
	...
	xTaskCreate( led_control,
				 ( const char * ) "led_control",
				 configMINIMAL_STACK_SIZE,
				 NULL,
				 tskIDLE_PRIORITY,
				 &xLedControl );
